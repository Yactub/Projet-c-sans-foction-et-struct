...
int main() {
    ...
    do {
        printf("\n========= MENU =========\n");
        printf("1. Saisie matieres (nom + coef)\n");
        printf("2. Ajouter etudiant\n");
        printf("3. Mettre a jour etudiant (ecraser)\n");
        printf("4. Supprimer etudiant\n");
        printf("5. Rechercher etudiant (ID / Nom)\n");
        printf("6. Affichage (aperçu etudiants + matieres)\n");
        printf("7. Classement par moyenne\n");
        printf("8. Affichage alphabetique\n");
        printf("9. Moyenne par matiere\n");
        printf("10. Moyenne globale\n");
        printf("11. Best/Worst par etudiant\n");
        printf("12. Best/Worst par matiere\n");
        printf("13. Etudiants sans moyenne\n");
        printf("0. Quitter\n");
        printf("Choix: ");
            ...
            if (mode == 1) {
                ...
                for (i = 0; i < nbEtu; i++) {
                    if (id[i] == rid) {
                        ...
                        for (j = 1; j < nbMat; j++) {
                            if (note[i][j] > note[i][max]) max = j;
                            if (note[i][j] < note[i][min]) min = j;
                        }
                        printf("Best: %s %.2f | Worst: %s %.2f\n",
                               matNom[max], note[i][max], matNom[min], note[i][min]);
                        found = 1;
                    }
                }
            } else {
